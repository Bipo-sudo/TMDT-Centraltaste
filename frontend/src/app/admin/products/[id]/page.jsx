...
import { CheckCircle2, ImagePlus, Sparkles, WandSparkles } from 'lucide-react';
...
export default function AdminProductEditPage() {
  ...
  if (isLoading) {
    return (
      <section className="mx-auto w-full max-w-6xl rounded-[32px] border border-[rgba(201,168,76,0.14)] bg-[rgba(255,255,255,0.03)] p-6 text-white shadow-[0_20px_60px_rgba(0,0,0,0.16)] sm:p-8">
  ...
  return (
    <section className="space-y-6 text-white">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-[10px] uppercase tracking-[0.28em] text-[rgba(201,168,76,0.64)]">Admin / Products / Edit</p>
          <h1 className="mt-2 text-3xl font-light" style={{ fontFamily: 'var(--font-display)' }}>
            Sửa <em className="italic text-[#c9a84c]">sản phẩm</em>
          </h1>
          <p className="mt-1 text-sm text-[rgba(240,235,224,0.62)]">Cập nhật tên, giá, tồn kho và ảnh chính nhanh chóng.</p>
        </div>
      ...
      <form id="product-edit-form" onSubmit={handleSubmit} className="grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(360px,0.9fr)]">
        ...
        <aside>
          <div className="rounded-[20px] border border-[rgba(201,168,76,0.08)] bg-[rgba(255,255,255,0.02)] p-4">
            ...
            <div className="mt-4 text-sm text-[rgba(240,235,224,0.56)]">
              <p>• Ảnh sẽ ghi đè `main_image_url`.</p>
